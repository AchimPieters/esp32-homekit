// wolfssl user_settings.h for esp32-homekit
// copy this over the managed_components/wolfssl__wolfssl/include/user_settings.h
// this will need to be repeated if wolfssl is updated somehow
