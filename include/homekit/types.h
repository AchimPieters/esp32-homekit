...
typedef struct {
        ...
        union {
                ...
                struct {
                        uint8_t * data_value;
                        size_t data_size; };         }; } homekit_value_t;
...
typedef struct {
        int count;
        uint8_t * values;} homekit_valid_values_t;


typedef struct {
        uint8_t start;
        uint8_t end; } homekit_valid_values_range_t;


typedef struct {
        int count;
        homekit_valid_values_range_t * ranges;} homekit_valid_values_ranges_t;
...
typedef struct _homekit_characteristic_change_callback {
        ...
        void * context;
        struct _homekit_characteristic_change_callback * next;} homekit_characteristic_change_callback_t;
...
homekit_characteristic_t * \
    homekit_characteristic_clone(homekit_characteristic_t * characteristic);
